...
function setSetpieceKickOffTeam(matchDetails) {
  ...
  return setFreekicks.setFreekick(ballPosition, matchDetails.kickOffTeam, matchDetails.secondTeam, `top`, matchDetails)
}
...
function setSetpieceSecondTeam(matchDetails) {
  ...
  return setFreekicks.setFreekick(ballPosition, matchDetails.secondTeam, matchDetails.secondTeam, `top`, matchDetails)
}
