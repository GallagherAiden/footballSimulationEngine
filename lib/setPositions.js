	...
	return new Promise(function (resolve, reject) {
		if (team.players[0].originPOS[1] > matchDetails.pitchSize[1] / 2) {
			if (side === 'left') {
				...
				matchDetails.ball.position = [matchDetails.pitchSize[0], 0, 0]
				team.players[1].hasBall = true
				matchDetails.ball.ballOverIterations = []
				matchDetails.ball.withPlayer = true
				matchDetails.ball.Player = team.players[1].name
			...
			matchDetails.ball.position = [0, matchDetails.pitchSize[1], 0]
			team.players[1].hasBall = true
			matchDetails.ball.ballOverIterations = []
			matchDetails.ball.withPlayer = true
			matchDetails.ball.Player = team.players[1].name
			...
			matchDetails.ball.position = [matchDetails.pitchSize[0], matchDetails.pitchSize[1], 0]
			team.players[1].hasBall = true
			matchDetails.ball.ballOverIterations = []
			matchDetails.ball.withPlayer = true
			matchDetails.ball.Player = team.players[1].name
	...
	return new Promise(function (resolve, reject) {
		...
		if (side === 'left') {
			...
			setPlayerPositions(matchDetails, team, movement).then(function () {
				...
				matchDetails.ball.position = [matchDetails.pitchSize[0], place, 0]
				team.players[5].startPOS = matchDetails.ball.position.map(x => x)
				team.players[5].startPOS.pop()
				team.players[5].hasBall = true
				matchDetails.ball.ballOverIterations = []
		...
		if (team.players[0].originPOS[1] > matchDetails.pitchSize[1] / 2) {
			setPlayerPositions(matchDetails, team, -80).then(function () {
				setVariables.resetPlayerPositions(opposition).then(function () {
					matchDetails.ball.position = [matchDetails.pitchSize[0] / 2, matchDetails.pitchSize[1] - 20, 0]
			...
			setPlayerPositions(matchDetails, team, 80).then(function () {
				setVariables.resetPlayerPositions(opposition).then(function () {
					matchDetails.ball.position = [matchDetails.pitchSize[0] / 2, 20, 0]
					team.players[0].startPOS = matchDetails.ball.position.map(x => x)
					team.players[0].startPOS.pop()
					team.players[0].hasBall = true
					matchDetails.ball.ballOverIterations = []
...
function setSetpiece(matchDetails, team, opposition) {
	return new Promise(function (resolve, reject) {
		...
		} else if (common.isBetween(ballPosition[0], (matchDetails.pitchSize[0] / 4) - 5, matchDetails.pitchSize[0] - (matchDetails.pitchSize[0] / 4) + 5) && common.isBetween(ballPosition[1], matchDetails.pitchSize[1] - (matchDetails.pitchSize[1] / 6) + 5, matchDetails.pitchSize[1])) {
