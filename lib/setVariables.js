...
function koDecider(team1, matchDetails) {
  ...
  team1.players[playerWithBall].relativePOS = matchDetails.ball.position.map(x => x)
  ...
  team1.players[waitingPlayer].relativePOS = [matchDetails.ball.position[0] + 20, matchDetails.ball.position[1]]
  return team1
}
