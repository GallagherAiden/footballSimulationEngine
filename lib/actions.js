      ...
      if (player.hasBall === false) {
        if (player.position === 'GK') {
          ...
          if (common.isBetween(ballX, -2, 2) && common.isBetween(ballY, -2, 2)) {
            if (player.originPOS[1] > (matchDetails.pitchSize[1] / 2)) {
              if (common.isBetween(player.startPOS[0], (matchDetails.pitchSize[0] / 4) - 5, matchDetails.pitchSize[0] - (matchDetails.pitchSize[0] / 4) + 5) && common.isBetween(player.startPOS[1], matchDetails.pitchSize[1] - (matchDetails.pitchSize[1] / 6) + 5, matchDetails.pitchSize[1])) {
                if (matchDetails.ball.withPlayer === false) {
                  ...
                  possibleActions = populatePossibleActions(possibleActions, 0, 0, 0, 0, 50, 0, 10, 20, 20, 0, 0)
                  resolve(possibleActions)
                }
            ...
            } else if (common.isBetween(player.startPOS[0], (matchDetails.pitchSize[0] / 4) - 5, matchDetails.pitchSize[0] - (matchDetails.pitchSize[0] / 4) + 5) && common.isBetween(player.startPOS[1], 0, (matchDetails.pitchSize[1] / 6) - 5)) {
              if (matchDetails.ball.withPlayer === false) {
                possibleActions = populatePossibleActions(possibleActions, 0, 0, 0, 0, 0, 0, 0, 20, 80, 0, 0)
                resolve(possibleActions)
              } else {
                possibleActions = populatePossibleActions(possibleActions, 0, 0, 0, 0, 40, 0, 20, 10, 30, 0, 0)
                resolve(possibleActions)
              }
            } else if (matchDetails.ball.withPlayer === false) {
              possibleActions = populatePossibleActions(possibleActions, 0, 0, 0, 0, 0, 0, 0, 20, 80, 0, 0)
            ...
            if (player.originPOS[1] > (matchDetails.pitchSize[1] / 2)) {
              if (common.isBetween(player.startPOS[0], (matchDetails.pitchSize[0] / 4) - 5, matchDetails.pitchSize[0] - (matchDetails.pitchSize[0] / 4) + 5) && common.isBetween(player.startPOS[1], matchDetails.pitchSize[1] - (matchDetails.pitchSize[1] / 6) + 5, matchDetails.pitchSize[1])) {
                ...
                possibleActions = populatePossibleActions(possibleActions, 0, 0, 0, 0, 50, 0, 50, 0, 0, 0, 0)
                resolve(possibleActions)
              }
            } else if (common.isBetween(player.startPOS[0], (matchDetails.pitchSize[0] / 4) - 5, matchDetails.pitchSize[0] - (matchDetails.pitchSize[0] / 4) + 5) && common.isBetween(player.startPOS[1], 0, (matchDetails.pitchSize[1] / 6) - 5)) {
              if (matchDetails.ball.withPlayer === false) {
        ...
        } else if (common.isBetween(player.startPOS[0], (matchDetails.pitchSize[0] / 4) - 5, matchDetails.pitchSize[0] - (matchDetails.pitchSize[0] / 4) + 5) && common.isBetween(player.startPOS[1], (matchDetails.pitchSize[1] - (matchDetails.pitchSize[1] / 6) + 5), matchDetails.pitchSize[1])) {
...
function resolveTackle(player, team, opposition, matchDetails) {
  return new Promise(function(resolve, reject) {
    ...
    async.eachSeries(
      opposition.players, function eachPlayer(thatPlayer, thatPlayerCallback) {
