	...
	return new Promise(function (resolve, reject) {
		...
		if (newPower < 75) {
			...
			if (deflectionPlayer.offside == true) {
				...
				var team = (deflectionTeam.name == kickOffTeam.name) ? matchDetails.kickOffTeam : matchDetails.secondTeam
				var opposition = (team.name == kickOffTeam.name) ? matchDetails.secondTeam : matchDetails.kickOffTeam
				setSetpiece(matchDetails, team, opposition).then(function () {
