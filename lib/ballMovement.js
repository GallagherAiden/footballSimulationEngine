...
function throughBall(matchDetails, teammates, player) {
  ...
  if (player.skill.passing > common.getRandomNumber(0, 100)) {
    if (player.originPOS[1] > pitchHeight / 2) {
      closestPlayerPosition = [targetPlayerXPos, common.getRandomNumber(targetPlayerYPos - 10, targetPlayerYPos - 20)]
    } else {
      closestPlayerPosition = [targetPlayerXPos, common.getRandomNumber(targetPlayerYPos + 10, targetPlayerYPos + 30)]
    }
