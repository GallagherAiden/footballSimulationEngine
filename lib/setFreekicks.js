...
function setTopLowerFinalQtrBylinePos(matchDetails, attack, defence) {
  ...
  for (let player of attack.players) {
    if (player.position == 'GK') player.currentPOS = [player.originPOS[0], parseInt(pitchHeight * 0.25, 10)]
      ...
      if (player.position == 'CB') player.currentPOS = [player.originPOS[0], parseInt(pitchHeight * 0.5, 10)]
      else if (player.position == 'LB' || player.position == 'RB') player.currentPOS = [player.originPOS[0], parseInt(pitchHeight * 0.66, 10)]
    } else if (player.playerID != kickPlayer.playerID) player.currentPOS = common.getRandomBottomPenaltyPosition(matchDetails)
  }
...
function setBottomLowerFinalQtrBylinePos(matchDetails, attack, defence) {
  ...
  for (let player of attack.players) {
    if (player.position == 'GK') player.currentPOS = [player.originPOS[0], parseInt(pitchHeight * 0.75, 10)]
      ...
      if (player.position == 'CB') player.currentPOS = [player.originPOS[0], parseInt(pitchHeight * 0.5, 10)]
      else if (player.position == 'LB' || player.position == 'RB') player.currentPOS = [player.originPOS[0], parseInt(pitchHeight * 0.33, 10)]
    } else if (player.playerID != kickPlayer.playerID) player.currentPOS = common.getRandomTopPenaltyPosition(matchDetails)
  }
