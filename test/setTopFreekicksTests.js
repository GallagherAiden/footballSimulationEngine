...
function runTest() {
  ...
  //     let itlocation = './init_config/iteration.json'
  //     let nextJSON = await setfreekicks.setTopFreekick(itlocation)
  ...
  //     expect(STgoalie.startPOS).to.eql(STgoalie.originPOS)
  //     for (let num of [1, 2, 3, 4]) {
  //       let thisPlayer = kickOffTeam.players[num].startPOS
  //       let thatPlayer = secondTeam.players[num].startPOS
  ...
  //     let boundaryY = [pitchHeight, pitchHeight - (pitchHeight / 6) + 5]
  ...
  //     expect(nextJSON).to.be.an('object')
  //     expect(nextJSON.ball.direction).to.eql('south')
  //     expect(nextJSON.ball.position).to.eql([340, parseInt(pitchHeight - (pitchHeight / 6) + 4, 10)])
  //     expect(kickOffTeam.players[5].startPOS).to.eql([340, parseInt(pitchHeight - (pitchHeight / 6) + 4, 10)])
  //     expect(KOTgoalie.startPOS).to.eql(KOTgoalie.originPOS[0], parseInt(pitchHeight * 0.25, 10))
  //     expect(STgoalie.startPOS).to.eql(STgoalie.originPOS)
  //     for (let num of [1, 2, 3, 4]) {
  //       let thisPlayer = kickOffTeam.players[num].startPOS
  ...
  //     expect(nextJSON.ball.position).to.eql([10, pitchHeight - 47])
  //     expect(kickOffTeam.players[5].startPOS).to.eql([10, pitchHeight - 47])
  //     expect(KOTgoalie.startPOS).to.eql(KOTgoalie.originPOS[0], parseInt(pitchHeight * 0.25, 10))
  //     expect(STgoalie.startPOS).to.eql(STgoalie.originPOS)
  //     for (let num of [1, 2, 3, 4]) {
  //       let thisPlayer = kickOffTeam.players[num].startPOS
  ...
  //     expect(nextJSON.ball.position).to.eql([600, pitchHeight - 25])
  //     expect(kickOffTeam.players[5].startPOS).to.eql([600, pitchHeight - 25])
  //     expect(KOTgoalie.startPOS).to.eql(KOTgoalie.originPOS[0], parseInt(pitchHeight * 0.25, 10))
  //     expect(STgoalie.startPOS).to.eql(STgoalie.originPOS)
  //     for (let num of [1, 2, 3, 4]) {
  //       let thisPlayer = kickOffTeam.players[num].startPOS
  ...
  //     let KOTgoalie = kickOffTeam.players[0]
  //     let STgoalie = secondTeam.players[0]
  //     let firstWallPosition = pitchHeight - 1
  ...
  //     expect(nextJSON).to.be.an('object')
  //     expect(nextJSON.ball.direction).to.eql('west')
  //     expect(nextJSON.ball.position).to.eql([600, pitchHeight - 1])
  //     expect(kickOffTeam.players[5].startPOS).to.eql([600, pitchHeight - 1])
  //     expect(KOTgoalie.startPOS).to.eql(KOTgoalie.originPOS[0], parseInt(pitchHeight * 0.25, 10))
  //     expect(STgoalie.startPOS).to.eql(STgoalie.originPOS)
  //     for (let num of [1, 2, 3, 4]) {
  //       let thisPlayer = kickOffTeam.players[num].startPOS
