...
function runTest() {
  mocha.describe('testTeamSetup()', function() {
    ...
    mocha.it('check all players relative positions are the same as the start positions', async() => {
      ...
      expect(teamOutput).to.be.an('object')
      expect(teamOutput.players[0].intendedPOS).to.eql(teamOutput.players[0].currentPOS)
      expect(teamOutput.players[1].intendedPOS).to.eql(teamOutput.players[1].currentPOS)
      expect(teamOutput.players[2].intendedPOS).to.eql(teamOutput.players[2].currentPOS)
      expect(teamOutput.players[3].intendedPOS).to.eql(teamOutput.players[3].currentPOS)
      expect(teamOutput.players[4].intendedPOS).to.eql(teamOutput.players[4].currentPOS)
      expect(teamOutput.players[5].intendedPOS).to.eql(teamOutput.players[5].currentPOS)
      expect(teamOutput.players[6].intendedPOS).to.eql(teamOutput.players[6].currentPOS)
      expect(teamOutput.players[7].intendedPOS).to.eql(teamOutput.players[7].currentPOS)
      expect(teamOutput.players[8].intendedPOS).to.eql(teamOutput.players[8].currentPOS)
      expect(teamOutput.players[9].intendedPOS).to.eql(teamOutput.players[9].currentPOS)
      expect(teamOutput.players[10].intendedPOS).to.eql(teamOutput.players[10].currentPOS)
    })
  })
}
